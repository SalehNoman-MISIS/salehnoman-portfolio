/**
 * Project case studies (source of truth for /projects/[slug]).
 * Gallery `file` values live under public/screenshots/<slug>/ ; the site resolves
 * them automatically. Real UI captures use neutral display names — no client
 * brands or codenames are shown.
 */
...
export const projects: Project[] = [
  {
    slug: "ats-detection-system",
    title: "ATS Detection System — M.Sc. Thesis",
    order: 1,
    featured: true,
    ...
    summary:
      "Master's thesis: a 4-tier detection cascade over 1,651 features that identifies the ATS platform behind all 500 Fortune-500 career pages at 100% coverage, with SHAP explainability.",
    tech: ["Python", "scikit-learn", "XGBoost", "RandomForest", "SHAP", "Playwright", "Selenium", "BeautifulSoup", "pytest"],
    repoVisibility: "private",
    thumb: "cascade-architecture.png",
    metrics: [
      { value: "100%", label: "Detection (500 / 500)" },
      { value: "0.88", label: "Mean confidence" },
      { value: "30", label: "ATS providers identified" },
      { value: "1,651", label: "Feature dimensions" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "cascade-architecture.png", alt: "Diagram of the 4-tier ATS detection cascade.", caption: "The 4-tier detection cascade — each request stops at the first confident match." },
      { file: "shap-feature-importance.png", alt: "SHAP feature-importance plot for ATS classification.", caption: "SHAP feature importance — the signals that most drive each prediction." },
      { file: "confusion-matrix.png", alt: "Confusion matrix across ATS provider classes.", caption: "Confusion matrix across ATS provider classes." },
      { file: "market-share-pie.png", alt: "Pie chart of Fortune-500 ATS market share.", caption: "Fortune-500 ATS market share — a Workday + Greenhouse duopoly." },
      { file: "provider-distribution.png", alt: "Bar chart of companies per ATS provider.", caption: "Provider distribution across all 500 companies." },
      { file: "confidence-distribution.png", alt: "Histogram of detection confidence scores.", caption: "Confidence distribution and confidence by detection method." },
    ],
    deepDive: [
  ...
  {
    slug: "ai-job-scraping-platform",
    title: "AI-Assisted Job-Scraping Platform",
    order: 2,
    featured: true,
    category: "Data Engineering · AI Agents",
    year: "2025",
    oneLiner:
      'A multi-source job scraper whose "source builder" uses an AI agent to generate a validated scraper config from any URL.',
    summary:
      "A FastAPI + Playwright platform that ingests job boards from YAML/CSS configs — with an agentic source builder that turns any job-board URL into a working, validated scraper in minutes.",
    tech: ["Python", "FastAPI", "Playwright", "Alpine.js", "SQLite", "Claude / GPT SDKs", "Directus", "pytest"],
    repoVisibility: "private",
    thumb: "sources.png",
    metrics: [
      { value: "200+", label: "Automated tests (live + non-live)" },
      { value: "minutes", label: "URL → working scraper" },
      { value: "3", label: "Fetch modes (basic / stealth / Playwright)" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "sources.png", alt: "Multi-source scraping dashboard with per-source health and freshness.", caption: "The sources dashboard — health, jobs found and freshness per source." },
      { file: "ai-source-builder.png", alt: "The Generate Source with AI modal, choosing an LLM provider and a job-board URL.", caption: '"Generate Source with AI" — an LLM turns a URL into a validated config.' },
      { file: "dashboard.png", alt: "Pipeline overview dashboard with run stats and drift alerts.", caption: "Overview dashboard — run stats, freshness and extraction-drift alerts." },
      { file: "database.png", alt: "Normalized jobs and companies stored in the database.", caption: "Normalized jobs & companies, ready to push to the CMS." },
      { file: "pipeline.svg", alt: "Diagram of the ingestion pipeline into a headless CMS.", caption: "The ingestion pipeline — config → scrape → normalize → CMS." },
    ],
    deepDive: [
  ...
  {
    slug: "data-enrichment-platform",
    title: "Contact Data Enrichment Platform",
    order: 3,
    featured: true,
    category: "Full-stack · Commercial Product",
    year: "2025",
    oneLiner:
      "A full-stack app that extracts and verifies contact data from CMS collections or URL lists — shipped commercially as a licensed Windows app.",
    summary:
      "A React + Flask + Playwright/Scrapling suite that turns thousands of company URLs into verified emails, phones and socials — with a Google-Maps website finder and a signed per-client licensing system.",
    tech: ["Python", "Flask", "React", "Playwright", "Scrapling", "Google Maps", "SMTP", "PyInstaller"],
    repoVisibility: "private",
    thumb: "source-selection.png",
    metrics: [
      { value: "5-step", label: "Guided enrichment wizard" },
      { value: "4", label: "Export formats (JSON / CSV / TSV / JSONL)" },
      { value: "Licensed", label: "Shipped as a signed Windows app" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "source-selection.png", alt: "Wizard step 1: choose a data source — CMS, URL list, or Google Maps finder.", caption: "Step 1 — choose a source: CMS collection, URL list, or Google-Maps finder." },
      { file: "url-input.png", alt: "Wizard step for pasting a list of website URLs to enrich.", caption: "Paste a URL list to extract and verify contacts in bulk." },
      { file: "directus-connect.png", alt: "Form to connect to a Directus CMS instance with credentials never stored.", caption: "Connect to a headless CMS — credentials encrypted, never stored." },
      { file: "gmaps-finder.svg", alt: "Diagram of the Google Maps website finder flow.", caption: "The Google-Maps website finder backfills missing sites before enrichment." },
      { file: "architecture.svg", alt: "Architecture: React, Flask, Playwright/Scrapling and a CMS.", caption: "Architecture — React ↔ Flask ↔ Playwright / Scrapling ↔ CMS." },
    ],
    deepDive: [
  ...
  },
  {
    ...
    title: "Browser Automation Agent Platform",
    order: 4,
    featured: true,
    ...
    summary:
      "A Node.js + Playwright platform with a visual Flow Builder (26 step types) that composes reusable browser agents into workflows — triggerable from n8n via a single HTTP endpoint, with real-time SSE logs.",
    tech: ["Node.js", "Express", "Playwright", "Alpine.js", "n8n", "Server-Sent Events", "ngrok"],
    repoVisibility: "private",
    thumb: "flow-builder-canvas.png",
    metrics: [
      { value: "26", label: "Flow step types" },
      { value: "7", label: "Reusable browser agents" },
      { value: "1", label: "n8n endpoint, 3 execution modes" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "flow-builder-canvas.png", alt: "The Create New Flow builder with steps, triggers and agent selection.", caption: "The visual Flow Builder — compose typed steps, triggers and agents." },
      { file: "agents-list.png", alt: "The seven reusable browser agents in the agent runner.", caption: "Seven reusable browser agents, runnable directly or embedded in a flow." },
      { file: "n8n-integration.png", alt: "The n8n integration screen with a single endpoint and three modes.", caption: "n8n integration — one endpoint, three modes, copy-paste-ready payloads." },
      { file: "flow-engine.svg", alt: "Diagram of the flow engine composing agents.", caption: "The flow engine — 26 step types over reusable agents." },
    ],
    deepDive: [
  ...
  {
    slug: "backlink-price-aggregator",
    title: "Backlink Marketplace Price Aggregator",
    order: 5,
    featured: false,
    category: "Web Scraping · Desktop App",
    year: "2025",
    oneLiner:
      "A secure desktop tool that checks a domain across five marketplaces and writes the cheapest price back to a Google Sheet.",
    summary:
      "A local-web desktop tool that prices any domain across five backlink marketplaces using anti-detect browsers, then writes the best price straight into a Google Sheet — shipped as a one-click, encrypted Windows installer.",
    tech: ["Python", "Camoufox", "Incogniton", "Google Sheets API", "PBKDF2 + Fernet", "PyInstaller", "GitHub Actions"],
    repoVisibility: "private",
    thumb: "platforms.png",
    metrics: [
      { value: "5", label: "Marketplaces priced per domain" },
      { value: "1-click", label: "Windows installer (cloud-built)" },
      { value: "Fernet", label: "Encrypted credentials at rest" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "platforms.png", alt: "Platforms and logins screen listing five marketplaces with column mapping and fees.", caption: "Five marketplaces — per-column mapping, fee rules, and encrypted saved logins." },
      { file: "run.png", alt: "Run screen with platform selection and a live browser option.", caption: "The Run tab — pick platforms, watch the browser, or run headless." },
      { file: "workflow.svg", alt: "Workflow diagram: domain list priced across five marketplaces into a sheet.", caption: "The pricing workflow — domain list → five marketplaces → cheapest → Sheet." },
      { file: "security.svg", alt: "Security model: PBKDF2 key derivation and Fernet encryption.", caption: "Credential security — PBKDF2 + Fernet, master password never stored." },
    ],
    deepDive: [
  ...
  {
    slug: "gender-prediction-model",
    title: "Gender-Prediction ML Model",
    order: 6,
    featured: false,
    category: "Machine Learning",
    year: "2025",
    oneLiner:
      "An end-to-end classification pipeline with gradient-boosted models and macro-F1 threshold tuning.",
    summary:
      "An end-to-end classification pipeline built during an applied-ML course: ingestion, cleaning and multi-source merging, feature engineering, and gradient-boosted models (CatBoost / LightGBM) tuned for macro-F1.",
    tech: ["Python", "pandas", "NumPy", "scikit-learn", "CatBoost", "LightGBM", "SHAP"],
    repoVisibility: "private",
    thumb: "pipeline.svg",
    metrics: [
      { value: "CatBoost", label: "+ LightGBM, k-fold CV" },
      { value: "macro-F1", label: "Threshold-tuned objective" },
      { value: "5+", label: "Merged data sources" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "pipeline.svg", alt: "Diagram of the end-to-end ML pipeline.", caption: "The end-to-end ML pipeline — ingest → merge → engineer → train → evaluate." },
      { file: "roc-pr.svg", alt: "ROC and precision-recall curves versus baseline.", caption: "ROC and precision–recall curves versus baseline." },
      { file: "feature-importance.svg", alt: "Feature-importance chart.", caption: "Feature importance — which engineered signals mattered most." },
    ],
    deepDive: [
  ...
  },
  {
    ...
    title: "Google Maps Business Data Scraper",
    order: 7,
    featured: false,
    ...
    summary:
      "A Python + RTILA scraper that harvests Google Maps business listings (schools, companies) into structured records, paired with a data-analysis stage that profiles completeness, categories and contact coverage.",
    tech: ["Python", "RTILA Studio", "Playwright", "pandas", "Directus", "Matplotlib"],
    repoVisibility: "private",
    thumb: "completeness.png",
    metrics: [
      { value: "ETL", label: "Scrape → normalize → Directus" },
      { value: "7", label: "Analysis reports generated" },
      { value: "Quality", label: "Completeness & coverage profiling" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "completeness.png", alt: "Bar chart of field-level completeness across the dataset.", caption: "Field-level completeness across the harvested dataset." },
      { file: "categories.png", alt: "Chart of the top 15 business categories.", caption: "Top-15 business categories in the dataset." },
      { file: "contact-types.png", alt: "Breakdown of contact types present in the records.", caption: "Contact-type breakdown across records." },
      { file: "social-coverage.png", alt: "Chart of social-profile coverage across organisations.", caption: "Social-profile coverage across organisations." },
    ],
    deepDive: [
  ...
  {
    slug: "tutoring-website",
    title: "Tutoring & Booking Website",
    order: 8,
    featured: false,
    category: "Full-stack · Web App",
    year: "2025",
    oneLiner: "A responsive tutoring site with lesson booking, backed by Supabase (Postgres).",
    summary:
      "A responsive marketing-plus-booking website for a private tutor: a clean front end backed by Supabase (Postgres) for lesson bookings, with a SQL schema and one-command deploy.",
    tech: ["JavaScript", "Supabase", "PostgreSQL", "HTML / CSS", "Static hosting"],
    repoVisibility: "private",
    thumb: "hero.png",
    metrics: [
      { value: "Supabase", label: "Postgres backend + auth" },
      { value: "Responsive", label: "Mobile-first, bilingual (EN/AR)" },
      { value: "Booking", label: "Live lesson-slot flow" },
    ],
    highlights: [
    ...
    gallery: [
      { file: "hero.png", alt: "Tutoring website hero with a live available-slots panel.", caption: "The hero — value prop, CTAs and a live available-slots panel." },
      { file: "booking.png", alt: "Before-and-after outcomes section of the tutoring site.", caption: "Social proof — real before/after learner outcomes." },
      { file: "architecture.svg", alt: "Architecture: static front end talking directly to Supabase.", caption: "Architecture — a static front end directly on Supabase (Postgres)." },
    ],
    deepDive: [
